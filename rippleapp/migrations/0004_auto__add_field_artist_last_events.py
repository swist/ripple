...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.last_events'
        db.add_column(u'rippleapp_artist', 'last_events',
                      self.gf('picklefield.fields.PickledObjectField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.last_events'
        db.delete_column(u'rippleapp_artist', 'last_events')
